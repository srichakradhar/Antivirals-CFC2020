...
async function main(params) {
  ...
  if (params.type === "api") {
    ...
    tweets = await client.get('search/tweets', { q: params.input });
    ...
    var message = ''
    if (count > 0) {
      message += 'The news seems to be legitimate as it has been tweeted by '
              + count + ' official accounts';
    } else {
      message += 'There were no references from official accounts regarding this news. Please be careful while sharing.'
    }
